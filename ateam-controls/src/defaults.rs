...
pub const DEFAULT_VISION_MIN_LATENCY_US: u32 = 15000;
pub const DEFAULT_VISION_MIN_SAMPLES_VARIANCE: usize = 25;
pub const DEFAULT_VISION_MAX_AGE_VARIANCE_US: u32 = 1_000_000;  // 1s
pub const DEFAULT_VISION_MIN_SAMPLES_TIME_SYNC: usize = 100;
pub const DEFAULT_VISION_MAX_AGE_TIME_SYNC_US: u32 = 10_000_000;  // 10s
pub const DEFAULT_VISION_MAX_AGE_ACCEPTANCE_US: u32 = 35_000;  // 35 ms
pub const DEFAULT_VISION_INACTIVE_THRESHOLD_US: u32 = 300_000;  // 300 ms