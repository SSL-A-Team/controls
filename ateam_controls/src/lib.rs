...
pub fn compute_positive_triangular_profile(sd0: f64, ds: f64, sdd: f64) -> (f64, f64, f64) {
...
pub fn compute_positive_trapezoidal_profile(sd0: f64, ds: f64, sdd: f64, sd_max: f64) -> (f64, f64, f64, f64) {
...
pub fn compute_break(s0: f64, sd0: f64, sdd: f64) -> (f64, f64) {
    let time_to_rest = sd0.abs() / sdd.abs();
    let sf = s0 + 0.5 * sd0 * time_to_rest;
    (time_to_rest, sf)
}

pub fn compute_optimal_traj_1d(s0: f64, sd0: f64, s_trg: f64, sd_max: f64, sdd_max: f64) -> Trajectory1D {
...
pub fn compute_traj1d_state_at_t(traj: Trajectory1D, s: f64, sd: f64, current_time: f64, t: f64) -> (f64, f64) {
    let mut s = s;
    let mut sd = sd;
